...
if __name__ == '__main__':
    ...
    test_distances_mah2 = metrics.mahalanobis_metric({'L': parameters}, query_features, gallery_features)
    distances = {'mink1': test_distances_m1, 'mink2': test_distances_m2, 'cc': test_distances_cc,
                 'cos': test_distances_cos, 'bi': test_distances_bis, 'mah_cov': test_distances_mah1,
                 'mah_I': test_distances_mah2}
