...
if __name__ == '__main__':
    ...
    bisim = metrics.BilinearSimilarity(torch.rand(query_features.shape[0], query_features.shape[0]), cosine=False)
    ...
    for i in range(1, 21, 1):
        ...
        # io.recorder.update('Baselines', rank=rank, testm1_mAp=total_score_m1, testm2_mAp=total_score_m2, testcc_mAp=total_score_cc,
        #                    testcos_mAp=total_score_cos, testbis_mAp=total_score_bis, testmah_mAp=total_score_mah)
